...
class InitiateStudentImportHandler implements CommandHandler
{
    public function handle(Command $command): mixed
    {
        /** @var InitiateStudentImportCommand $command */
        ...
        Cache::put('student_import_' . $importId, $rows, now()->addHours(2));
