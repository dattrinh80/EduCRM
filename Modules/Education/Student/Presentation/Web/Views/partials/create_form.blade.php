...
<form action="{{ route('admin.students.store') }}" method="POST" class="flex-1 flex flex-col overflow-hidden">
    @csrf
                ...
                <div class="p-5 bg-indigo-50/30 rounded-2xl border border-indigo-100 space-y-4">
                    ...
                    <div class="space-y-4">
                        <div class="space-y-1.5">
                            ...
                            <select name="center_id" required class="w-full h-10 px-3 bg-white border border-slate-200 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-all text-sm outline-none">
