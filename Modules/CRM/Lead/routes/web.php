...
Route::middleware(['web', 'auth'])->prefix('admin')->name('admin.')->group(function () {
    Route::resource('lead-statuses', \Modules\CRM\LeadStatus\Presentation\Web\LeadStatusWebController::class)->except(['show'])->middleware('permission:leads.update');
    Route::resource('lead-tags', \Modules\CRM\LeadTag\Presentation\Web\LeadTagWebController::class)->except(['show'])->middleware('permission:leads.update');
