...
Route::middleware(['web', 'auth'])->prefix('admin/customers')->name('admin.customers.')->group(function () {
    ...
    Route::get('/create', [CustomerWebController::class, 'create'])->name('create')->middleware('permission:customers.create');
    ...
    Route::get('/{id}/edit', [CustomerWebController::class, 'edit'])->name('edit')->middleware('permission:customers.update')->whereUuid('id');
...
Route::middleware(['web', 'auth'])->prefix('admin')->name('admin.')->group(function () {
    Route::resource('customer-tags', \Modules\CRM\CustomerTag\Presentation\Web\CustomerTagWebController::class)->except(['show'])->middleware('permission:customers.update');
});
