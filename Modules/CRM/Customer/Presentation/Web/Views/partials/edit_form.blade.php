...
<form action="{{ route('admin.customers.update', $customer->id) }}" method="POST" class="p-6 flex-1 overflow-y-auto">
    @csrf
    @method('PUT')
    <div class="space-y-4">
        <div class="grid grid-cols-2 gap-4">
            <div class="space-y-1">
                ...
                <div class="relative">
                    ...
                    <input type="text" name="name" required class="w-full pl-10 pr-4 py-2 bg-slate-50/50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 text-sm transition" value="{{ old('name', $customer->name) }}">
                </div>
            ...
            <div class="space-y-1">
                ...
                <div class="relative">
                    ...
                    <input type="text" name="phone" required class="w-full pl-10 pr-4 py-2 bg-slate-50/50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 text-sm transition tabular-nums" value="{{ old('phone', $customer->phone) }}">
                </div>
        ...
        <div class="grid grid-cols-2 gap-4">
            <div class="space-y-1">
                ...
                <div class="relative">
                    ...
                    <input type="email" name="email" class="w-full pl-10 pr-4 py-2 border border-slate-200 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 text-sm transition" value="{{ old('email', $customer->email) }}">
                </div>
            ...
            <div class="space-y-1">
                ...
                <div class="relative">
                    ...
                    <input type="date" name="dob" class="w-full pl-10 pr-4 py-2 border border-slate-200 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 text-sm transition" value="{{ old('dob', $customer->dob ? \Carbon\Carbon::parse($customer->dob)->format('Y-m-d') : '') }}">
                </div>
            </div>
            ...
            <div class="space-y-1 col-span-2 sm:col-span-1">
                ...
                <div class="grid grid-cols-3 gap-2">
                    <label class="cursor-pointer">
                        <input type="radio" name="gender" value="MALE" class="peer hidden" {{ old('gender', $customer->gender) === 'MALE' ? 'checked' : '' }}>
                    ...
                    <label class="cursor-pointer">
                        <input type="radio" name="gender" value="FEMALE" class="peer hidden" {{ old('gender', $customer->gender) === 'FEMALE' ? 'checked' : '' }}>
                    ...
                    <label class="cursor-pointer">
                        <input type="radio" name="gender" value="OTHER" class="peer hidden" {{ old('gender', $customer->gender) === 'OTHER' ? 'checked' : '' }}>
                ...
                <div class="relative">
                    ...
                    <select name="center_id" required class="w-full pl-10 pr-4 py-2 border border-slate-200 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 text-sm transition appearance-none bg-white">
                        ...
                        @foreach($centers as $center)
                            <option value="{{ $center->id }}" {{ old('center_id', $customer->center_id) === $center->id ? 'selected' : '' }}>[{{ $center->code }}] {{ $center->name }}</option>
                        @endforeach
                    </select>
        ...
        <div class="space-y-1 mt-4">
            ...
            <div class="relative">
                ...
                <input type="text" name="address" class="w-full pl-10 pr-4 py-2 border border-slate-200 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 text-sm transition" value="{{ old('address', $customer->address) }}">
            </div>
        </div>
        ...
        <div class="space-y-1 mt-4">
            ...
            <div class="flex flex-wrap gap-2 p-3 border border-slate-100 rounded-xl bg-slate-50/50">
                ...
                <label class="relative flex items-center group cursor-pointer">
                    <input type="checkbox" name="tag_ids[]" value="{{ $tag->getId() }}" {{ in_array($tag->getId(), old('tag_ids', $customerTagIds)) ? 'checked' : '' }} class="peer appearance-none absolute">
