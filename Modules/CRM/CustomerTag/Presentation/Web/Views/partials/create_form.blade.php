...
<form action="{{ route('admin.customer-tags.store') }}" method="POST" id="createCustomerTagForm" class="p-6 flex-1 overflow-y-auto">
    @csrf
    <div class="space-y-4">
        <div class="space-y-1">
            ...
            <div class="relative">
                ...
                <input type="text" name="name" required class="w-full pl-10 pr-4 py-2 border border-slate-200 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 text-sm transition" value="{{ old('name') }}" placeholder="Vd: VIP">
            </div>
