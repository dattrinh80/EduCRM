...
<form action="{{ route('admin.centers.store') }}" method="POST" id="createCenterForm" class="p-6 flex-1 overflow-y-auto">
    @csrf
    <div class="space-y-4">
        <div class="grid grid-cols-2 gap-4">
            <div class="space-y-1">
                ...
                <div class="relative">
                    ...
                    <input type="text" name="code" required class="w-full pl-10 pr-4 py-2 border border-slate-200 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 text-sm transition font-mono uppercase" value="{{ old('code') }}" placeholder="Vd: HN-01">
                </div>
            ...
            <div class="space-y-1">
                ...
                <div class="relative">
                    ...
                    <input type="text" name="name" required class="w-full pl-10 pr-4 py-2 border border-slate-200 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 text-sm transition" value="{{ old('name') }}" placeholder="Nhập tên cơ sở..">
                </div>
        ...
        <div class="grid grid-cols-2 gap-4">
            <div class="space-y-1">
                ...
                <div class="relative">
                    ...
                    <input type="text" name="phone" class="w-full pl-10 pr-4 py-2 border border-slate-200 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 text-sm transition" value="{{ old('phone') }}" placeholder="Số điện thoại..">
                </div>
            ...
            <div class="space-y-1">
                ...
                <div class="relative">
                    ...
                    <input type="email" name="email" class="w-full pl-10 pr-4 py-2 border border-slate-200 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 text-sm transition" value="{{ old('email') }}" placeholder="Email liên hệ..">
                </div>
        ...
        <div class="space-y-1">
            ...
            <div class="relative">
                ...
                <input type="text" name="address" class="w-full pl-10 pr-4 py-2 border border-slate-200 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 text-sm transition" value="{{ old('address') }}" placeholder="Địa chỉ cơ sở..">
            </div>
