...
<div class="space-y-6">
    <div>
        <h1 class="text-2xl font-display font-bold text-slate-800 tracking-tight">Permissions Overview</h1>
        <p class="text-slate-500 mt-1 flex items-center gap-1.5 text-sm">
            <i data-lucide="info" class="w-3.5 h-3.5 opacity-60"></i>
            All system permissions grouped by module ({{ $totalPermissions }} total)
        </p>
    </div>
    ...
    <div class="space-y-4">
            ...
            <x-slot name="header">
                <div class="flex items-center justify-between w-full">
                    <div class="flex items-center gap-3">
                        <div class="w-10 h-10 rounded-xl bg-violet-100/50 text-violet-600 flex items-center justify-center">
        ...
        <x-ui.empty-state 
            ...
            description="The system doesn't have any permissions registered in this group or module."
            icon="key"
        />
